...
public class PopulationChangesDataRetriever {
    public ArrayList<PopulationChangesData> getData(Context context, String municipality) {
        ...
        try {
            ...
            JsonNode jsonInputString = objectMapper.readTree(context.getResources().openRawResource(R.raw.queryy));
            ...
            ArrayList<PopulationChangesData> populationChangesData = new ArrayList<>();

            for(int i = 0; i < years.size(); i++) {
                populationChangesData.add(new PopulationChangesData(Integer.valueOf(years.get(i)), Integer.valueOf(populations.get(i))));
            }

            return populationChangesData;
